...
DATABASES = {
    'default': {
        ...
        'NAME': 'database23', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'database23.c700686mu29d.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'fp-bucket-n' # please enter your s3 bucket name
